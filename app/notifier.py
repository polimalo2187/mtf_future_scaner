...
# ======================================================
# PUSH DE NUEVA SEÑAL (POR PLAN, BLOQUEO AJUSTADO)
# ======================================================
...
async def notify_new_signal_alert(
    ...
    **kwargs,
    ...
    Bloquea envío solo si hay señal activa para este plan
    """

    # ❗ Revisar señales activas en Telegram solo para este plan
    now = datetime.utcnow()
    active_signals = list(
