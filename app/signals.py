...
from app.notifier import notify_new_signal_alert  # Asegúrate de que esta versión acepte solo bot y base_signal
...
def generate_user_signal(base_signal: Dict, user_id: int) -> Dict:
    ...
    user_signal = {
        ...
        "leverage_profiles": base_signal.get("leverage", {}),
        "margin_mode": base_signal.get("margin_mode", "isolated"),
