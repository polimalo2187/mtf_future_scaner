...
def can_create_new_signal() -> bool:
    """
    Retorna True solo si no hay ninguna señal vigente en Telegram.
    Mientras exista una señal activa (telegram_valid_until > now), bloquea cualquier creación/envío.
    """
    now = datetime.utcnow()
