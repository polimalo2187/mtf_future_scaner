...
def get_latest_base_signal_for_user(user: Dict) -> Optional[List[Dict]]:
    ...
    # ADMIN siempre obtiene señales PREMIUM
...
def get_latest_base_signal_for_plan(user: Dict):
    """
    Función de compatibilidad con handlers antiguos.
    """
...
def format_user_signal(signal: Dict) -> str:
    """
    Devuelve la señal en formato legible, mostrando exchange y perfiles.
    """
