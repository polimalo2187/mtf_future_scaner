...
def create_base_signal(
    ...
    # Generar señales por usuario automáticamente
...
def generate_user_signal_for_plan(base_signal: Dict):
    ...
    for user in users_collection().find({}):
        ...
        has_access = user.get("plan_end") is None or user.get("plan_end") > datetime.utcnow()
