...
from app.database import (
    ...
    users_collection,  # Necesario para obtener exchange del usuario
)
...
def create_base_signal(
    ...
    timeframes: List[str],
    visibility: str,
    supported_exchanges: Optional[List[str]] = None,  # Nuevo campo
) -> Dict:
    ...
    signal["supported_exchanges"] = supported_exchanges or ["binance"]
...
def generate_user_signal(base_signal: Dict, user: Dict) -> Dict:
    ...
    user_signal = {
        ...
        "exchange": user.get("exchange", "binance"),  # Nuevo campo para mostrar
    }
        ...
        signals_collection().find(
            {
                ...
                "supported_exchanges": {"$in": [user_exchange]},  # Filtrar por exchange
            },
            sort=[("created_at", -1)],
