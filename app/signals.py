...
def estimate_minutes_to_entry(timeframes: List[str]) -> tuple[int, int]:
    """
...
def create_base_signal(
    ...
    est_min, est_max = estimate_minutes_to_entry(timeframes)
...
def generate_user_signal(base_signal: Dict, user_id: int) -> Dict:
    ...
    user_signal = {
        ...
        "estimated_entry_minutes": base_signal["estimated_entry_minutes"],
    }
