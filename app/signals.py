...
def create_base_signal(
    ...
    timeframes: List[str],
    visibility: str,
    block_after_creation: bool = True,  # NUEVO
) -> Dict:

    # NO bloqueamos de inmediato; el escáner decide cuándo bloquear
    ...
    signal.update({
        ...
        # Por defecto, siempre se establece 15 min; bloqueo real controlado por escáner
    ...
    # Solo bloquea la creación de nuevas señales si el escáner indica
    if block_after_creation:
        logger.info("🔒 Bloqueo activado por 15 minutos después de última señal")
