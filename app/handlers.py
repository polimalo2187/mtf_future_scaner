...
async def handle_admin_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    success = activate_premium(user_id)
    if success:
        await update.message.reply_text(f"✅ Plan PREMIUM activado para el usuario {user_id}.")
    else:
        await update.message.reply_text(f"❌ No se pudo activar el plan para el usuario {user_id}.")
      # Limpiar flag
