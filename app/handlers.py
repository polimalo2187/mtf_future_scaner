...
from app.referrals import get_user_referral_stats  # ✅ NUEVO IMPORT
...
# ======================================================
# HANDLER REFERRALS (NUEVA FUNCIÓN) ✅
# ======================================================

async def handle_referrals(query, user):
    """Muestra la información de referidos del usuario."""
    try:
        ...
        # Código de referido
        message += f"📋 Tu código de referido:\n`{stats['ref_code']}`\n\n"
        ...
        message += "1. Comparte tu código con amigos\n"
        message += "2. Ellos usan tu código al unirse\n"
        message += "3. Cuando activen un plan, tú ganas\n\n"
        ...
        keyboard = [
            [InlineKeyboardButton("📋 Copiar código", callback_data="copy_ref_code")],
...
# ======================================================
# HANDLER PARA COPIAR CÓDIGO DE REFERIDO
# ======================================================
...
async def handle_copy_ref_code(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Enviar mensaje con el código para copiar
        await query.edit_message_text(
            text=f"📋 Tu código de referido es:\n\n`{ref_code}`\n\n"
...
# ======================================================
# REGISTRO DE HANDLERS (ACTUALIZADO CON REFERRALS)
# ======================================================
