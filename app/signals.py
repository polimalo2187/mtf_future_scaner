...
def estimate_minutes_to_entry(
    ...
    """
    Estima el tiempo para que el precio alcance la zona de entrada
    usando distancia real al mercado y velocidad estimada.
    NO bloquea la señal. Solo informativo.
    """
    ...
    try:
        ...
        min_est = max(1, int(minutes_estimated * 0.6))
        max_est = int(minutes_estimated * 1.4)
