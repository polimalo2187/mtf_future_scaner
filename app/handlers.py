...
from app.referrals import get_user_referral_stats, get_referral_link, register_valid_referral
...
async def handle_admin_text_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        context.user_data["awaiting_user_id"] = False
# ======================================================
# HANDLER VIEW SIGNALS (sin límite diario)
# ======================================================
...
async def handle_view_signals(query, user, admin, users_col):
    try:
        ...
        # Obtener todas las señales disponibles según el plan
        ...
        # Tomar la primera señal más reciente
        base_signal = base_signals[0]

        # Generar señal personalizada para el usuario
...
async def handle_plans(query):
    await query.edit_message_text(
        "💼 PLANES DISPONIBLES\n\n"
        "🟢 FREE – todas las señales disponibles\n"
        "🟡 PLUS – todas las señales disponibles\n"
        "🔴 PREMIUM – todas las señales disponibles\n\n"
