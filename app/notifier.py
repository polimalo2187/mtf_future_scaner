...
# ======================================================
# PUSH DE NUEVA SEÑAL (CON BLOQUEO SEÑAL ACTIVA)
# ======================================================
...
async def notify_new_signal_alert(
    ...
    **kwargs,
    ...
    Bloquea envío si hay señal activa en Telegram para ese plan.
    """

    # ❗ Revisar señales activas en Telegram para este plan
    active_signals = list(
    ...
    if active_signals:
        logger.info(f"⏸️ Push bloqueado: ya existe señal activa para {signal_visibility}")
        return
