...
# ======================================================
# UTILIDAD – TIEMPO OPERATIVO SEGÚN TIMEFRAMES
# ======================================================
...
def calculate_signal_validity(timeframes: List[str]) -> int:
    """
    La vigencia de la señal se basa en el timeframe MAYOR.
    Ej: 5M / 15M / 1H → 60 minutos
    """
    minutes = [
        TIMEFRAME_TO_MINUTES.get(tf.upper(), 0)
        for tf in timeframes
    ]
    return max(minutes) if minutes else 15  # fallback seguro
...
# ======================================================
# COMPATIBILIDAD CON HANDLERS (CRÍTICO)
# ======================================================
