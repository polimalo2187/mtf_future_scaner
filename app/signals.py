...
def estimate_minutes_to_entry(timeframes: List[str]) -> Dict[str, int]:
    """
    Estima el tiempo en minutos para que el precio alcance
    la zona de entrada, basado en el timeframe de ejecución (15M).
    Totalmente independiente de horarios y zonas geográficas.
    """
    ...
    min_estimate = max(1, int(base * 0.5))
    max_estimate = int(base * 1.5)
