...
# ======================================================
# HANDLER REFERRALS - CORREGIDO Y ROBUSTO
# ======================================================
...
async def handle_referrals(query, user):
    ...
    try:
        ...
        try:
            ...
            logger.error(f"❌ Error en get_user_referral_stats para {user_id}: {db_error}")
            await query.edit_message_text(
        ...
        # ✅ VERIFICACIÓN 4: Estadísticas válidas
        if not stats:
        ...
        logger.error(f"❌ Falta clave en datos del usuario: {e}. Usuario: {user}")
        await query.edit_message_text(
