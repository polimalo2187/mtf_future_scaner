...
# Tiempo en segundos antes de borrar el mensaje
...
async def notify_new_signal_alert(
    ...
    El mensaje se borra automáticamente para no ensuciar el chat.
    """
    ...
    for user_id in user_ids:
        try:
            ...
            # Espera breve para que el push llegue
            await asyncio.sleep(ALERT_AUTO_DELETE_SECONDS)

            # Borra el mensaje para mantener el chat limpio
